...
BLOG_TITLE = "@rtnpro"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.rtnpro.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "rtnpro@gmail.com"
BLOG_DESCRIPTION = "A small window into my life and work."  # (translatable)
...
TWITTER_CARD = {
     ...
     'site': '@rtnpro',  # twitter nick for the website
     # 'site:id': 123456,  # Same as site, but the website's Twitter user ID
                           # instead.
     'creator': '@rtnpro',  # Username for the content creator / author.
     # 'creator:id': 654321,  # Same as creator, but the Twitter user's ID.
}
